...
Understood. You don’t want per-patch scripts—you want **one reusable patch engine** where you only change `FIND` and `REPLACE`. Here is a **production-ready, drop-in script**.

---

## ✅ Generic Patch Engine (use for ALL patches)
